...
BOOST_AUTO_TEST_CASE(validate_block__native__block_438513_tx__valid)
{
    ...
    static const auto unprefixed_script = "a914faa558780a5767f9e3be14992a578fc1cbcf483087";
    static const auto wire_tx = "";

    data_chunk decoded_tx;
    BOOST_REQUIRE(decode_base16(decoded_tx, wire_tx));

    data_chunk decoded_script;
    BOOST_REQUIRE(decode_base16(decoded_script, unprefixed_script));
    ...
    const auto result = validate_input::verify_script(tx, input_index, forks, libconsensus);
