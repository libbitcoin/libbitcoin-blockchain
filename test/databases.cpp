...
BOOST_AUTO_TEST_CASE(spend_db_test)
{
    chain::output_point key1{
        hash_literal("4129e76f363f9742bc98dd3d40c99c9066e4d53b8e10e5097bd6f7b5059d7c53"), 110};
    chain::output_point key2{
        hash_literal("eefa5d23968584be9d8d064bcf99c24666e4d53b8e10e5097bd6f7b5059d7c53"), 4};
    chain::output_point key3{
        hash_literal("4129e76f363f9742bc98dd3d40c99c90eefa5d23968584be9d8d064bcf99c246"), 8};
    chain::output_point key4{
        hash_literal("80d9e7012b5b171bf78e75b52d2d149580d9e7012b5b171bf78e75b52d2d1495"), 9};

    chain::input_point val1{
        hash_literal("4742b3eac32d35961f9da9d42d495ff1d90aba96944cac3e715047256f7016d1"), 0};
    chain::input_point val2{
        hash_literal("d90aba96944cac3e715047256f7016d1d90aba96944cac3e715047256f7016d1"), 0};
    chain::input_point val3{
        hash_literal("3cc768bbaef30587c72c6eba8dbf6aeec4ef24172ae6fe357f2e24c2b0fa44d5"), 0};
...
{
    chain::block genesis = chain::block::genesis_mainnet();
...
BOOST_AUTO_TEST_CASE(history_db_test)
{
    ...
    chain::input_point spend22{
        hash_literal("3cc768bbaef30587c72c6eba8dbfffffc4ef24172ae6fe357f2e24c2b0fa44d5"), 0};
    ...
    //output_point out42{
    //    hash_literal("aaaaaaaaaaacac3e715047256f7016d1d90aaa96944cac3e715047256f7016d1"), 0};
