...
bool validate_block::passes_checkpoints()
{
    ...
    if (height_ == 279000 && block_hash !=
            hash_digest{{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01,
                         0xae, 0x8c, 0x72, 0xa0, 0xb0, 0xc3, 0x01, 0xf6,
                         0x7e, 0x3a, 0xfc, 0xa1, 0x0e, 0x81, 0x9e, 0xfa,
                         0x90, 0x41, 0xe4, 0x58, 0xe9, 0xbd, 0x7e, 0x40}})
        return false;

    if (height_ == 295000 && block_hash !=
            hash_digest{{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                         0x4d, 0x9b, 0x4e, 0xf5, 0x0f, 0x0f, 0x9d, 0x68,
                         0x6f, 0xd6, 0x9d, 0xb2, 0xe0, 0x3a, 0xf3, 0x5a,
                         0x10, 0x03, 0x70, 0xc6, 0x46, 0x32, 0xa9, 0x83}})
        return false;

    if (height_ == 330791 && block_hash !=
            hash_digest{{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                         0x17, 0xa4, 0xb1, 0x76, 0x29, 0x45, 0x83, 0x51,
                         0x90, 0x76, 0xf0, 0x6c, 0xd2, 0xb5, 0xe4, 0xef,
                         0x13, 0x9d, 0xad, 0xa8, 0xd4, 0x48, 0x38, 0xd8}})
        return false;

    if (height_ == 337444 && block_hash !=
            hash_digest{{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                         0x13, 0xd4, 0x35, 0x84, 0x59, 0x35, 0xd0, 0xba,
                         0xae, 0x97, 0x76, 0xa3, 0x74, 0x8a, 0xb1, 0x98,
                         0xa8, 0x4a, 0xd8, 0x47, 0x46, 0x31, 0x5f, 0x9b}})
        return false;
