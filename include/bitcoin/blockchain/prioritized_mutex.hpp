 ...
 */
#ifndef LIBBITCOIN_BLOCKCHAIN_PRIORITIZED_MUTEX_HPP
#define LIBBITCOIN_BLOCKCHAIN_PRIORITIZED_MUTEX_HPP
...
class BCB_API prioritized_mutex
{
public:
...
private:
    ...
    boost::shared_mutex next_mutex_;
    boost::shared_mutex wait_mutex_;
};
